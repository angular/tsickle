...
const ast_printing_transform_1 = require("./ast_printing_transform");
...
describe('decorator_downlevel_transformer', () => {
    ...
    function translate(sourceText, allowErrors = false) {
        ...
        const files = new Map();
        const { diagnostics } = tsickle.emit(program, transformerHost, (path, contents) => { }, undefined, undefined, undefined, { beforeTs: [(0, ast_printing_transform_1.createAstPrintingTransform)(files)] });
        if (!allowErrors) {
            testSupport.expectDiagnosticsEmpty(diagnostics);
        }
        return {
    ...
    function expectTranslated(sourceText) {
...
class Foo {
  ...
  [param]() {}
            ...
            expect(testSupport.formatDiagnostics(diagnostics))
                .toBe('testcase.ts(5,3): error TS0: cannot process decorators on strangely named method\n');
        });
...
//# sourceMappingURL=decorator_downlevel_transformer_test.js.map