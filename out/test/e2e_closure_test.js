...
describe('golden file tests', () => {
    ...
    it('compile with Closure', (done) => {
        ...
        const tests = (0, test_support_1.goldenTests)().filter(t => !t.isDeclarationTest);
        // Collect all JavaScript outputs generated from .ts files.
        const goldenJs = [].concat(...tests.map(t => t.jsPaths()));
        ...
        goldenJs.push('src/closure_externs.js', 'third_party/tslib/externs.js', 'third_party/tslib/tslib.js', 'test/googbase_fake.js', 'test_files/augment/shim.js', 'test_files/clutz_type_value.no_externs/type_value.js', 'test_files/clutz.no_externs/default_export.js', 'test_files/clutz.no_externs/some_name_space.js', 'test_files/clutz.no_externs/some_other.js', 'test_files/declare_export_dts/shim.js', 'test_files/declare_import/closure_default_export.js', 'test_files/declare_import/closure_named_export.js', 'test_files/declare_import/exporting.js', 'test_files/declare/shim.js', 'test_files/export_equals.shim/shim.js', 'test_files/fake_goog_reflect.js', 'test_files/googmodule_esmodule.declaration.no_externs/some_module.js', 'test_files/googmodule_esmodule.no_externs/some_module.js', 'test_files/import_by_path.no_externs/jsprovides.js', 'test_files/import_equals/exporter.js', 'test_files/import_from_goog.no_externs/closure_LegacyModule.js', 'test_files/import_from_goog.no_externs/closure_Module.js', 'test_files/import_from_goog.no_externs/closure_OtherModule.js', 'test_files/reexport_type_from_goog.no_externs/closure_LegacyModule.js', 'test_files/reexport_type_from_goog.no_externs/closure_Module.js', 'test_files/reexport_type_from_goog.no_externs/closure_OtherModule.js', 'test_files/type_propaccess.no_externs/nested_clazz.js');
        const externs = tests.map(t => t.externsPath()).filter(fs.existsSync);
        const startTime = Date.now();
        const total = goldenJs.length;
        if (!total)
            throw new Error('No JS files in ' + JSON.stringify(goldenJs));
        const CLOSURE_FLAGS = {
...
//# sourceMappingURL=e2e_closure_test.js.map