...
class Annotator extends ClosureRewriter {
  ...
  constructor(
    ...
    this.externsWriter = new ExternsWriter(typeChecker, file, host, options);
  }
...
export function annotate(
  ...
  return new Annotator(typeChecker, file, host, options, tsHost, tsOpts, sourceMapper).annotate();
}
