...
export {ModulesManifest, type FileMap} from './modules_manifest';
export {FileSummary, ModuleType, Type, type Symbol} from './summary';
...
export function emit(
  ...
  if (host.transformTypesToClosure) {
    ...
    for (const sourceFile of sourceFiles) {
      ...
      const {output, diagnostics, moduleNamespace} = generateExterns(
        typeChecker,
        sourceFile,
        host,
      );
