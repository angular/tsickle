...
describe('convertCommonJsToGoogModule', () => {
  ...
  it('adds a goog.module call', () => {
    ...
    expectCommonJs('a.js', `console.log('hello');`)
        .to.equal(`goog.module('a');var module = {id: 'a'};console.log('hello');`);
  });

  it('adds a goog.module call to empty files',
     () => { expectCommonJs('a.js', ``).to.equal(`goog.module('a');var module = {id: 'a'};`); });

  it('adds a goog.module call to empty-looking files', () => {
    expectCommonJs('a.js', `// empty`).to.equal(`goog.module('a');var module = {id: 'a'};// empty`);
  });
...
console.log('hello');`)
        .to.equal(`goog.module('a');var module = {id: 'a'};
console.log('hello');`);
  });

  it('converts require calls', () => {
    expectCommonJs('a.js', `var r = require('req/mod');`)
        .to.equal(`goog.module('a');var module = {id: 'a'};var r = goog.require('req$mod');`);
  });

  it('converts require calls without assignments on first line', () => {
    expectCommonJs('a.js', `require('req/mod');`)
        .to.equal(
            `goog.module('a');var module = {id: 'a'};var unused_0_ = goog.require('req$mod');`);
  });
...
`).to.equal(`goog.module('a$b');var module = {id: 'a/b'};var foo_1 = goog.require('foo');
var foo_2 = foo_1;
